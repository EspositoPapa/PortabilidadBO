            ...
            <div id="cuadricula">
                ...
                <form>
                    <div <div style="margin-left: 5px;">
                        <label>Número de Solicitud PNM:__________<u><?php echo $ExternalCase[$i] ?></u>__________ 
                        <label style="display: inline-block;">Fecha:</label>
                            <?php echo $hoy ?></label>
                        <p>
                            <label>Número PIN:</label>__________<u><?php echo $Pin[$i] ?></u>__________
                        </p>
                        <p>
                            <label>Nro. Línea receptora PIN:</label>________<u><?php echo $telefono[$i] ?></u>________
                        </p>
                    </div>
                </form>
            </div>
            ...
            <div id="cuadricula">
                ...
                <form>
                    ...
                    <p>
                        ...
                        <?php 
                            if ($email[$i]==''){
                                echo '__________  <input type="checkbox" id="checkbox" name="checkbox" checked><label>(No posee)</label>';
                            }else{
                ...
                <form>
                    <div style="margin-left: 10px;">
                        ...
                        <input type="checkbox" id="checkbox" name="checkbox" checked>&nbsp;&nbsp;
                            ...
                            <label>Apellido y Nombres / Apoderado:</label>
                            __________<u><?php echo $Cliente[$i] ?></u>__________<br> 
                            <labeL>Firma:</labeL>
                            <!--<img type="image" width="300" height="100">&nbsp;&nbsp;&nbsp;-->
                                ...
                                ?>
                            <label>Fecha:</label>__________<u><?php echo $hoy ?></u>__________
                    </div>  
                </form>
            </div>
