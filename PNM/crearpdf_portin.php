<?php
    ...
    // Leer la imagen y codificarla en base64 para que se pegue en PDF
    $imagen_data = base64_encode(file_get_contents('C:\xampp\htdocs\PortabilidadBO\PNM\img\Captura.jpg'));
    $imagen_data1= base64_encode(file_get_contents('C:\xampp\htdocs\PortabilidadBO\PNM\img\img_firmas\\'.$dni[$i].'.jpg'));
    ...
    //Logica para autocompletar firma del formulario
    if($operador[$i]=='MOVISTAR'){
        $infooperador= '<img width="150" height="60" src='. $image_mov.'>';
    }else{
        $infooperador= '<img width="150" height="60" src='. $image_cla .'>';
    }
                    ...
                    <div id="cuadricula">
                        ...
                        <form>
                            <div <div style="margin-left: 5px;">
                                <label>Número de Solicitud PNM:__________<u>'.  $ExternalCase[$i] .' </u>__________ 
                                <label style="display: inline-block;">Fecha:</label>
                                    '. $hoy .'
                                <p>
                                    <label>Número PIN:</label>__________<u>'. $Pin[$i].'</u>__________
                                </p>
                                <p>
                                    <label>Nro. Línea receptora PIN:</label>________<u>'.$telefono[$i].' </u>________
                                </p>
                            </div>
                        </form>
                    </div>
                    ...
                    <div id="cuadricula">
                        ...
                        <form>
                            ...
                            <p>
                                ...
                                __________<u>'. $Cliente[$i].'</u>__________
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                __________<u>'. $dni[$i] .'</u>__________
                            </p>
                            <p>
                    ...
                    <div id="cuadricula">
                        ...
                        <div style="margin-left: 5px;">
                            <p>
                                ...
                                ________<u>'.$operador[$i] .'</u>________
                            </p>
                            <p>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr height="20">
                                    ...
                                    <td width="200" align="CENTER" Style="border: black solid 1px" bgcolor="#FFFFFF">
                                       <font style="FONT-SIZE:11pt" face="Calibri" color="#000000"><b>'. $tlineas_portar[$i] .'</b></font>
                                    </td>
                                    <td width="200" height="20" align="CENTER" Style="border: black solid 1px" bgcolor="#FFFFFF">
                                        <font style="FONT-SIZE:11pt" face="Calibri" color="#000000"><b>'. $telefono[$i] .'</b></font>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                    ...
                                    <p>
                                        ...
                                        ________<u>'. $tlineas_portar[$i] .'</u>________
                                    </p>
                        </div>            
                        </form>
                    </div>
                        ...
                        <form>
                            <div style="margin-left: 10px;">
                                ...
                                <input type="checkbox" id="checkbox" name="checkbox" checked>&nbsp;&nbsp;
                                    ...
                                    <label>Apellido y Nombres / Apoderado:</label>
                                    __________<u>'. $Cliente[$i] . ' </u>__________<br> 
                                    <div style="padding: 20px 5px;">
                                        <labeL>Firma: '.  $infooperador .' </labeL>
                                        <label>Fecha:</label>__________<u>'.$hoy .'</u>__________
                                    </div>
                            </div>  
                        </form>
                    </div>
