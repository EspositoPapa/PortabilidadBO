...
//$imagen_data1= base64_encode(file_get_contents('C:\xampp\htdocs\PortabilidadBO\PNM\img\img_firmas\\'.$i['dni'].'.jpg'));
    ...
    if($i['operador']=='MOVISTAR'){
        $infooperador= '<img width="150" height="45">';
    }else{
                        ...
                        <form>
                            <div style="margin-left: 10px;">
                                ...
                                <input type="checkbox" id="checkbox" name="checkbox" checked>&nbsp;&nbsp;
                                    ...
                                    <labeL><div style="position: relative;float: left; margin-top:1cm;">Firma: '.  $infooperador .' </div></label>
                                    <div style="position: relative;float: right;margin-top:1cm;">
                                    <label>Fecha:</label>__________<u>'.$hoy .'</u>__________</labeL>
                                    </div>
                            </div>  
                        </form>
                    </div>
        ...
        //**********DIRIGE A SU SALIDA POR OPERADOR*/ 
        if($i['operador']=='MOVISTAR'){
            $filename ='C:/PNM/' . $i['ExternalCase'] . '_Portin.pdf';
        }else{
            $filename ='C:/PNMClaro/' . $i['ExternalCase'] . '_Portin.pdf';
        };
        //******************************************* */
