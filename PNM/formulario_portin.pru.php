<?php //require 'formulario_portinprueba.php';
    require 'pdf_relleno.php';
?>
<!--

//for ($i = 0; $i < count($Cliente); $i++) :
//$image = '../img/img_firmas/'. $dni . '.jpg';
?>
-->
<!DOCTYPE html>
    <html lang="es">
                ...
                <form>
                    <fieldset>
                        <div id="formu">
                            ...
                            __________<u><?php echo $ExternalCase ?></u>__________ 
                            <label style="padding-left: 80%;">Fecha:</label>
                            <?php echo $hoy ?>
                            </div>
                            </label>
                            ...
                            __________<u><?php echo $Pin ?></u>__________
                            </p>
                            <p>
                            <label>Nro. Línea receptora PIN:</label>
                            ________<u><?php echo $telefono ?></u>________
                        </p>
                        </div>
                    </fieldset>
                </form>
                    ...
                    <form>
                        <fieldset>
                            ...
                            <p>
                                ...
                                __________<u><?php echo $Cliente ?></u>__________
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                __________<u><?php echo $dni ?></u>__________
                            </p>
                            <p>
                ...
                <form>
                    <fieldset>
                            <p>
                                ...
                                ________<u><?php echo $operador ?></u>________
                            </p>
                            <p>
                                ...
                                <!-------------------------------------------------------------------------------------->
                                        <tr height="20">
                                            ...
                                            <td width="200" align="CENTER" Style="border: black solid 1px" bgcolor="#FFFFFF">
                                                <font style="FONT-SIZE:11pt" face="Calibri" color="#000000"><b><?php echo $tlineas_portar ?></b></font>
                                            </td>
                                            <td width="200" height="20" align="CENTER" Style="border: black solid 1px" bgcolor="#FFFFFF">
                                                <font style="FONT-SIZE:11pt" face="Calibri" color="#000000"><b><?php echo $telefono ?></b></font>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <p>
                                ...
                                ________<u><?php echo $tlineas_portar ?></u>________
                            </p>
                    </fieldset>
                </form>
            </div>
